...
from dg_sim.models.pedestrian import PedestrianState, PedestrianGeometry
from dg_sim.models.vehicle import VehicleState, VehicleGeometry
from dg_sim.models.vehicle_ligths import LightsColors
