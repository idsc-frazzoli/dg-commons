...
class Queue(ABC):
    """
    Abstract class for queues. The class was adapted to dg-commons
    from the original code from CommonRoad (Cyber-Physical Systems Group, Technical University of Munich):
    https://gitlab.lrz.de/tum-cps/commonroad-search/-/blob/master/SMP/motion_planner/queue.py
    """
    def __init__(self):
        self.list_elements = []
...
class FIFOQueue(Queue):
    """
    Implementation of First-In First-Out queues. The class was adapted to dg-commons
    from the original code from CommonRoad (Cyber-Physical Systems Group, Technical University of Munich):
    https://gitlab.lrz.de/tum-cps/commonroad-search/-/blob/master/SMP/motion_planner/queue.py
    """
    def __init__(self):
...
class LIFOQueue(Queue):
    """
    Implementation of Last-In First-Out queues. The class was adapted to dg-commons
    from the original code from CommonRoad (Cyber-Physical Systems Group, Technical University of Munich):
    https://gitlab.lrz.de/tum-cps/commonroad-search/-/blob/master/SMP/motion_planner/queue.py
    """
    def __init__(self):
...
class PriorityQueue:
    """
    Implementation of queues of items with priorities. The class was adapted to dg-commons
    from the original code from CommonRoad (Cyber-Physical Systems Group, Technical University of Munich):
    https://gitlab.lrz.de/tum-cps/commonroad-search/-/blob/master/SMP/motion_planner/queue.py
    """
    def __init__(self):
