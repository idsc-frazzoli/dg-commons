...
class PlanLFAgent(Agent):
    ...
    def __init__(
        ...
        all_queries_list: List[Trajectory],
        ...
        self.all_queries_list = all_queries_list
    ...
    def on_get_extra(
        ...
        if not self.return_extra:
            return None
        colors_opt = ["gold" for traj in self.trajectories]
        traj_opt = list(zip(self.trajectories, colors_opt))
        colors_queries = ["blue" for traj in self.all_queries_list]
        queries = list(zip(self.all_queries_list, colors_queries))
